    ...
    return (
      <section className={s.sectionAboutFuneralEscortByMedicalPersonnal}>
        <div className={'container ' + s.aboutFuneralEscortByMedicalPersonnal__container}>
            ...
            <p className='description'>У компетенції похоронного бюро <b>“Профритуал”</b> супровід похорону у повному обсязі з наданням кваліфікованих медичних працівників, співробітників для навантаження-розвантаження труни з тілом, спецліфту, необхідного у похованні.</p>                
