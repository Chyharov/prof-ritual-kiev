    ...
    return (
      <section className={s.sectionAboutDocumentsForFuneral}>
        <div className={'container ' + s.DocumentsForFuneral__container}>
          ...
          <p style={{marginBottom: '10px'}} className='description'>Оформлення похорону і підготовка документів померлого це тривалий і скрупульозний процес, який якщо зробити не правильно, вперше може принести безліч проблем з переоформленням. «Проф Ритуал» займається оформленням документів <b>для похорону понад 17 років</b>, і ми знаємо як у найкоротші терміни оформити документацію для похорону.</p>

          <p style={{marginBottom: '10px'}} className='description'><b>Організація похоронуу зазвичай включає:</b> юридичне оформлення похорону, а саме збір всіх необхідних документів для похорону. Медичне свідоцтво про смерть оформляється в морзі (або поліклініці) на підставі:</p>
