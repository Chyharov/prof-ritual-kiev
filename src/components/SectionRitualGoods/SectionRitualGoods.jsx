      ...
      <section className={s.sectionRitualGoods}>
        <div className={'container ' + s.ritualGoods__container}>
          ...
          <div className={s.ritualGoods__DescriprionContainer}>
            ...
            <p className={s.ritualGoods__description}>Продажем ритуальних товарів та приладдя наша компанія займається вже <b>більше 10 років</b>. Все ритуальне приладдя, яке ми маємо в наявності, ви можете подивитися відвідавши нас за адресою вул. Перта Запорожця 13 у місті Київ.</p>
