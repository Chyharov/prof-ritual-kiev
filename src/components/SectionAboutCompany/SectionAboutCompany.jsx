        ...
        <div className={'container ' + s.aboutCompany__container}>
          ...
          <div className={s.aboutCompany__storyContainer}>
            <h2 className={s.aboutCompany__title}>Про компанію</h2>
                <p className={s.aboutCompany_description} style={{marginBottom: '12px'}}>Похоронне бюро «Проф Ритуал» надає ритуальні послуги у місті Київ вже <b>понад 10 років.</b> Ми надаємо усі можливі ритуальні послуги за найдоступнішими цінами у місті Київ. Ми гарантуємо якісний та професійний підхід, завжди виконуємо послуги під час та за доступними цінами.</p>
