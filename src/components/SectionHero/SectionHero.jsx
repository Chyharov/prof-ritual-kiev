        ...
        <div className={'container ' + s.hero__container}>
            <h1 className={s.hero__title}>Проф Ритуал</h1>
                ...
                <p className={s.hero_description}>
                    Похоронна служба «Проф Ритуал» — турбота та підтримка у складні моменти" Ми допомагаємо організувати похорон або кремацію з гідністю та повагою, забезпечуючи повний комплекс ритуальних послуг у Києві та області
                </p>
