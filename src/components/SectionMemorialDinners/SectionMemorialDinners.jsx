    ...
    return (
      <section className={s.sectionMemorialDinners}>
        <div className={'container ' + s.memorialDinners__container}>
            ...
            <p style={{marginBottom: '10px'}} className='description'>Невід’ємною частиною та завершальним етапом церемонії поховання є <b>поминки та поминальний обід</b>. Прагнучи забезпечити цілісність і завершеність траурного обряду, похоронне бюро «Профритуал» надає можливість організації поминального обіду у спеціально обладнаних та використовуваних строго відповідно до їх призначення поминальних залах.</p>
