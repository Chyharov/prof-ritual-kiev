      ...
      <section className={s.sectionAboutRitualAccessories}>
        <div className={'container ' + s.aboutAboutRitual__container}>
            ...
            <img className={s.aboutAboutRitual__decoration} loading="lazy" src={RitualAccessoriesDecoration} alt="crosses__decoration" />
                ...
                <p className={s.aboutAboutRitual__description}>Ритуальне приладдя є невід’ємною частиною похорону. «Проф Ритуал» займається <b>продажем ритуальних товарів</b> та приладдя вже понад 20 років. Все ритуальне приладдя, яке ми маємо в наявності, ви можете подивитися відвідавши нас за адресою вул. Івана Федорова 33 у місті Київ. Або зателефонуйте нам, і коротко опішіть чого ви потребуєте а ми зробимо інше. В наявності є <b>більше 100 різних ритуальних речей</b>, які ми продаємо за найнижчими цінами в місті Київ. При покупці <Link className='links' to="/сoffins">ритуальної труни</Link> або <Link className='links' to="/ritualwreath">ритуальних вінків</Link> ми робимо великі знижки на багато ритуальних речей.</p>
