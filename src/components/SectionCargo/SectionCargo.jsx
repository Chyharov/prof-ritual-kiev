    ...
    return (
      <section className={s.sectionCargo}>
        <div className={'container ' + s.cargo__container}>
          ...
          <p style={{ marginBottom: '10px' }} className='description'>Наш агент контролює кожен етап та бере відповідальність перевезення на себе. За <b>8 років</b> наше похоронне бюро «Проф Ритуал» завжди вкладалося у терміни під час перевезення Вантаж 200. При проходженні кожного етапу ми сповіщаємо вас. У разі потреби наш агент супроводжує Вантаж 200 із зазначеного місця у пункт призначення.</p>
