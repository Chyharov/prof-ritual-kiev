    ...
    return (
      <section className={s.sectionCargo}>
        <div className={'container ' + s.cargo__container}>
            ...
            <p style={{ marginBottom: '10px' }} className='description'>Іноді трапляється так, що людина вмирає далеко від дому. Звичайно, родичі хочуть проводити покійного в останній шлях на його батьківщині. Однак транспортування тіла – це складна процедура, з якою не впоратися поодинці. У важку хвилину ми підставимо вам своє плече. Агенти ритуального бюро «Проф Ритуал» візьмуть на себе повну організацію прощального ритуалу. Пропоновані ритуальні послуги: перевезення Вантаж 200 від місця смерті <b>до місця поховання</b>.</p>

            <p style={{ marginBottom: '10px' }} className='description'>Ми розуміємо, що в години скорботи вам не хотілося б стикатися зі стомливим процесом щодо оформлення документів та відправлення вантажу 200. Тому «Проф Ритуал» у найкоротші терміни зберуть усі необхідні документи, серед яких:</p>    
          ...
          <p style={{ marginBottom: '10px' }} className='description'>Звертаючись до похоронного бюро «Проф Ритуал», ви зможете <b>уберегти свої нерви від зайвого стресу</b>. Ми доставимо тіло покійного та проведемо всі необхідні процедури з підготовки прощального ритуалу. Вам залишиться лише проводити його в інший світ.</p>
          ...
          <p style={{ marginBottom: '10px' }} className='description'>Наш агент контролює кожен етап та бере відповідальність перевезення на себе. За багато років наше похоронне бюро «Проф Ритуал» завжди вкладалося у терміни під час перевезення Вантаж 200. При проходженні кожного етапу ми сповіщаємо вас. У разі потреби наш агент супроводжує Вантаж 200 із зазначеного місця у пункт призначення.</p>
