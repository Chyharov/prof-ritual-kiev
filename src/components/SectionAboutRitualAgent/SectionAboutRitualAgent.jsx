    ...
    return (
      <section className={s.sectionAboutRitualAgent}>
        <div className={'container ' + s.aboutRitualAgent__container}>
            ...
            <p style={{marginBottom: '10px'}} className='description'>У спектр завдань спеціаліста входять визначення місця поховання або кремації, допомога у виборі <Link className='links' to="/сoffins">труни</Link> та <Link className='links' to="/ritualaccessories">іншого похоронного приладдя</Link>. У нашій компанії ви можете придбати як труну економ-класу, так і елітну поліровану труну, а також ми можемо виготовити труну за індивідуальним замовленням. Крім того, у нас представлений широкий асортимент іншого приладдя, у тому числі <Link className='links' to="/crosses">хрести на могилу</Link>, <Link className='links' to="/ritualwreath"> вінки з живих та штучних квітів</Link>, композиції на труну та багато іншого.</p>
           
            <h2 style={{marginBottom: '10px'}} className='title'>Агент похоронних послуг</h2>
        
            <blockquote style={{marginBottom: '10px'}} className='blockquote'>Наш агент <b> уважно поставиться</b> до всіх ваших побажань і супроводжуватиме весь процес до закінчення церемонії. Питання транспортування тіла (а також послуги Вантаж 200) ритуальні агенти також беруть на себе. Похоронний процес відбуватиметься відповідно до релігійних поглядів, яких дотримувався покійний. За бажанням клієнта здійснюється виклик священнослужителя.</blockquote>    
            
            <p style={{marginBottom: '10px'}} className='description'>Що стосується наших цін, у нас представлений широкий ціновий діапазон на послуги, тому вони доступні різним верствам населення.</p>
