    ...
    return (
      <section className={s.sectionAboutCrosses}>
        <div className={'container ' + s.aboutCrosses__container}>
            ...
            <p className={s.aboutCrosses__description}>Майстри в «Проф Ритуал» створюють ритуальні хрести, які відповідають своєму невтішному призначенню, але виглядають надзвичайно вишукано.</p>
